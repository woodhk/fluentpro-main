        ...
        <div className="w-full max-w-4xl mx-auto space-y-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2 text-purple-200/80">
              ...
              <span className="text-sm font-medium uppercase tracking-wider">Training Series 3/4</span>
              <div className="h-px flex-1 bg-purple-200/20"></div>
            </div>
            
            <h1 className="text-3xl md:text-4xl font-bold text-white text-center">
              L&D Portal for Admins & Leaders
            </h1>
            <p className="text-lg md:text-xl text-purple-200/80 text-center">
              Streamline Business English training with instant onboarding, advanced tracking, and company customization
            </p>
          </div>
