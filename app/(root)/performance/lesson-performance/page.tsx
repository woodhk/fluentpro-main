      ...
      <div className="max-w-6xl mx-auto px-6 -mt-6">
        ...
        <div className="bg-white rounded-lg p-4 mb-8">
          <div className="flex gap-6">
            <Link 
              href="/performance/unit-performance"
              className="text-gray-600 hover:text-gray-900 pb-2 transition-colors"
            >
              Unit Performance
            </Link>
            <div className="text-blue-600 border-b-2 border-blue-600 pb-2 font-medium">
              Lesson Performance
            </div>
          </div>
        </div>
        ...
        <Card className="shadow-sm bg-white mb-8">
          <CardHeader className="border-b bg-gray-50 p-4">
            <div className="grid grid-cols-12 w-full text-sm text-gray-600">
              ...
              <div className="col-span-2 font-medium">Repeats</div>
              <div className="col-span-3 font-medium">Best Performance</div>
              <div className="col-span-3 font-medium">Last Practiced</div>
            </div>
          </CardHeader>
          <CardContent className="p-0">
            <div className="divide-y">
              {lessons.map((lesson, index) => (
                ...
                >
                  <div className="col-span-4 text-gray-900 font-medium">{lesson.name}</div>
                  <div className="col-span-2 text-gray-600">{lesson.repeats}</div>
                  <div className="col-span-3">
                    <div className="flex items-center gap-2">
                      <div className={`text-white px-3 py-1 rounded-full text-sm ${
                        lesson.performance >= 80 ? 'bg-green-500' :
                        lesson.performance >= 70 ? 'bg-blue-500' : 'bg-orange-500'
                      }`}>
