...
const KeyVocabularyIntroduction = () => {
  ...
  const handleContinue = () => {
    router.push(`/lesson-practice/key-vocabulary-pt2/practice-vocabulary?lesson=${lessonSlug}`);
  };
              ...
              <div className="flex flex-col items-center text-center space-y-6">
                ...
                <div className="space-y-6 max-w-lg">
                  ...
                  <p className="text-lg leading-relaxed text-slate-700">
                    This stage will focus on the target language for each stage of the conversation.
                  </p>

                  <p className="text-lg leading-relaxed text-slate-700">
                    The aim is to focus on fully understanding the use of these key vocabularies by practicing different ways of saying them for different circumstances
                  </p>
